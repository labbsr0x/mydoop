...
describe('querySplitter', () => {
    describe('#separateQueriesByDistinct()', () => {
        let query = `SELECT
                        ...
                        count(distinct table_mock_alias.column_8) 
                        FROM
